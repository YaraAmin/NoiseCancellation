...
parser.add_argument('--audio_dir_prediction', default='./noise/denoised/', type=str)
...
parser.add_argument('--audio_input_prediction', default='./noise/', type=str)
#File name of sound output of denoise prediction
parser.add_argument('--audio_output_prediction', default='denoised', type=str)
